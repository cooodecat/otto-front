	...
	<div class="space-y-2">
		...
		{#if isEditing}
			<div class="space-y-3 rounded border bg-gray-50 p-3">
				...
				<!-- Base Path -->
				<div>
					<label class="mb-1 block text-sm font-medium text-gray-700">Base Path</label>
					<input
						type="text"
						bind:value={basePath}
						onchange={saveNodeData}
				...
				<!-- Output Directory -->
				<div>
					<label class="mb-1 block text-sm font-medium text-gray-700">Output Directory</label>
					<input
						type="text"
