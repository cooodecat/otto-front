  ...
  <div class="space-y-2">
    ...
    {#if isEditing}
      <div class="space-y-3 rounded border bg-gray-50 p-3">
        <!-- Mode 선택 -->
        <div>
          <label for="webpack-build-mode" class="mb-1 block text-sm font-medium text-gray-700"
            >Build Mode</label
          >
          <select
            id="webpack-build-mode"
            bind:value={mode}
        ...
        <!-- Config File -->
        <div>
          <label for="webpack-config-file" class="mb-1 block text-sm font-medium text-gray-700"
            >Config File</label
          >
          <input
        ...
        <!-- Output Path -->
        <div>
          <label for="webpack-output-path" class="mb-1 block text-sm font-medium text-gray-700"
            >Output Path</label
          >
          <input
            id="webpack-output-path"
            type="text"
