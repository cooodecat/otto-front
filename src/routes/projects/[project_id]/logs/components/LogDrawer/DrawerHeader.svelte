	...
	<div class="flex items-start gap-4">
		...
		<div class="flex-shrink-0 mt-1">
			{#if execution.executionType === 'BUILD'}
				<Hammer class="w-6 h-6 text-orange-500" />
		...
		<div class="flex-1">
			...
			<div class="mt-2 text-xs text-gray-500">
				Triggered by: <span class="font-medium">{execution.triggeredBy}</span> • 
				Pipeline: <span class="font-medium">{execution.pipelineName}</span>
			</div>
		</div>
	</div>
</div>