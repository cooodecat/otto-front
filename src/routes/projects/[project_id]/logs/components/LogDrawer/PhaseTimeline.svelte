  ...
  {#each phases as phase, i}
    ...
    >
      ...
      {#if i < phases.length - 1}
        <div
          class="connector absolute top-12 left-6 h-full w-0.5 -translate-x-1/2"
      ...
      <button
        ...
        class="phase-icon-wrapper relative z-10 flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full border-2 bg-white transition-all hover:scale-110"
